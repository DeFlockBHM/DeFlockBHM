...
To date, **136 municipalities** have deflocked. **91** of those (67%) have deflocked YTD and **128** of those (94%) have happened since the start of 2025. 
...
| Metric | Count |
|---|---|
| Municipalities deflocked (total) | 136 |
| ...deflocked YTD | 91 |
| ...since start of 2025 | 128 |
...
*Figures are computed directly from each tracker's published data file (links below) — news-sourced, not exhaustive court/police-record pulls; see each repo's `SCHEMA.md` for scope and caveats. Regenerated daily, last refreshed 2026-08-25.*
