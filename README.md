...
To date, **219 municipalities** have deflocked. **199** of those (91%) have deflocked YTD and **219** of those (100%) have happened since the start of 2025. At least **14,519,131 (~14.52M) people** live in a deflocked municipality (based on the **219** of those matched to Census population data). 
...
| Metric | Count |
|---|---|
| Municipalities deflocked (total) | 219 |
| ...deflocked YTD | 199 |
| ...since start of 2025 | 219 |
| ...in September so far | 58 |
| ...in August | 85 |
| ...matched to Census population data | 219 of 219 |
| People living in deflocked municipalities | 14,519,131 (~14.52M) |
...
*Figures are computed directly from each tracker's published data file (links below) — news-sourced, not exhaustive court/police-record pulls; see each repo's `SCHEMA.md` for scope and caveats. Regenerated daily, last refreshed 2026-09-18.*
...
*Counts are independent per outcome (see note above); computed directly from flock-officer-misuse's published data file — see its `SCHEMA.md` for how outcomes are tagged and its scope/caveats. Regenerated daily, last refreshed 2026-09-18.*
