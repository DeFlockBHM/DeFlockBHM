...
To date, **148 municipalities** have deflocked. **103** of those (70%) have deflocked YTD and **140** of those (95%) have happened since the start of 2025. 
...
| Metric | Count |
|---|---|
| Municipalities deflocked (total) | 148 |
| ...deflocked YTD | 103 |
| ...since start of 2025 | 140 |
...
*Figures are computed directly from each tracker's published data file (links below) — news-sourced, not exhaustive court/police-record pulls; see each repo's `SCHEMA.md` for scope and caveats. Regenerated daily, last refreshed 2026-08-28.*
