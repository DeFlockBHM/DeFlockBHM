...
To date, **133 municipalities** have deflocked. **88** of those (66%) have deflocked YTD and **125** of those (94%) have happened since the start of 2025. 
...
| Metric | Count |
|---|---|
| Municipalities deflocked (total) | 133 |
| ...deflocked YTD | 88 |
| ...since start of 2025 | 125 |
...
*Figures are computed directly from each tracker's published data file (links below) — news-sourced, not exhaustive court/police-record pulls; see each repo's `SCHEMA.md` for scope and caveats. Regenerated daily, last refreshed 2026-08-23.*
