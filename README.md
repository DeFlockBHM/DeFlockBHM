...
To date, **137 municipalities** have deflocked. **92** of those (67%) have deflocked YTD and **129** of those (94%) have happened since the start of 2025. 
...
| Metric | Count |
|---|---|
| Municipalities deflocked (total) | 137 |
| ...deflocked YTD | 92 |
| ...since start of 2025 | 129 |
...
*Figures are computed directly from each tracker's published data file (links below) — news-sourced, not exhaustive court/police-record pulls; see each repo's `SCHEMA.md` for scope and caveats. Regenerated daily, last refreshed 2026-08-26.*
